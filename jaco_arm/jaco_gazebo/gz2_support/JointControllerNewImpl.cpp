...
/////////////////////////////////////////////////
JointControllerNewImpl::JointControllerNewImpl(ModelPtr _model)
    : dataPtr(new JointControllerNewImplPrivate)
{
    ...
    if (this->dataPtr->model && this->dataPtr->model->GetWorld())
    {
        ...
        this->dataPtr->jointCmdSub = this->dataPtr->node->Subscribe(
                                         ...
                                         &JointControllerNewImpl::OnJointCmd, this);
    }
    else
    {
        gzwarn << "Unable to get world name. "
               << "JointControllerNewImpl will not receive commands via messages\n";
    }
}

/////////////////////////////////////////////////
JointControllerNewImpl::~JointControllerNewImpl()
{
    delete this->dataPtr;
    this->dataPtr = NULL;
}
...
/////////////////////////////////////////////////
void JointControllerNewImpl::AddJoint(JointPtr _joint)
{
...
/////////////////////////////////////////////////
void JointControllerNewImpl::Reset()
{
...
/////////////////////////////////////////////////
void JointControllerNewImpl::Update()
{
...
/////////////////////////////////////////////////
void JointControllerNewImpl::OnJointCmd(ConstJointCmdPtr &_msg)
{
    std::map<std::string, JointPtr>::iterator iter;
...
//////////////////////////////////////////////////
void JointControllerNewImpl::SetJointPosition(const std::string & _name,
...
//////////////////////////////////////////////////
void JointControllerNewImpl::SetJointPositions(
...
//////////////////////////////////////////////////
void JointControllerNewImpl::SetJointPosition(
    JointPtr _joint, double _position, int _index)
{
    _joint->SetAngle(_index, _position);
}

/////////////////////////////////////////////////
common::Time JointControllerNewImpl::GetLastUpdateTime() const
{
    return this->dataPtr->prevUpdateTime;
}

/////////////////////////////////////////////////
std::map<std::string, JointPtr> JointControllerNewImpl::GetJoints() const
{
    return this->dataPtr->joints;
}

/////////////////////////////////////////////////
std::map<std::string, common::PID> JointControllerNewImpl::GetPositionPIDs() const
{
    return this->dataPtr->posPids;
}

/////////////////////////////////////////////////
std::map<std::string, common::PID> JointControllerNewImpl::GetVelocityPIDs() const
{
    return this->dataPtr->velPids;
}

/////////////////////////////////////////////////
std::map<std::string, double> JointControllerNewImpl::GetForces() const
{
    return this->dataPtr->forces;
}

/////////////////////////////////////////////////
std::map<std::string, double> JointControllerNewImpl::GetPositions() const
{
    return this->dataPtr->positions;
}

/////////////////////////////////////////////////
std::map<std::string, double> JointControllerNewImpl::GetVelocities() const
{
    return this->dataPtr->velocities;
}

//////////////////////////////////////////////////
void JointControllerNewImpl::SetPositionPID(const std::string &_jointName,
...
/////////////////////////////////////////////////
bool JointControllerNewImpl::SetPositionTarget(const std::string &_jointName,
        double _target)
{
    bool result = false;
...
//////////////////////////////////////////////////
void JointControllerNewImpl::SetVelocityPID(const std::string &_jointName,
        const common::PID &_pid)
{
    std::map<std::string, JointPtr>::iterator iter;
    iter = this->dataPtr->joints.find(_jointName);
...
/////////////////////////////////////////////////
bool JointControllerNewImpl::SetVelocityTarget(const std::string &_jointName,
        double _target)
{
    bool result = false;
