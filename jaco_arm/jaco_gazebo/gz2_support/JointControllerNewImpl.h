...
namespace gazebo
{
  namespace physics
  {
    ...
    class JointControllerNewImpl;
    typedef boost::shared_ptr<JointControllerNewImpl> JointControllerNewImplPtr;
    ...
    /// \class JointControllerNewImpl JointControllerNewImpl.hh physics/physics.hh
    /// \brief A class for manipulating physics::Joint.
#if GAZEBO_MAJOR_VERSION >= GAZEBO_ADVANCED_JOINTCONTROLLER_VERSION
    class GZ_PHYSICS_VISIBLE JointControllerNewImpl
#else
    class JointControllerNewImpl
#endif
    {
      ...
      public: explicit JointControllerNewImpl(ModelPtr _model);

      /// \brief Destructor
      public: virtual ~JointControllerNewImpl();
      ...
      /// \sa JointControllerNewImpl::SetJointPosition(JointPtr, double)
      ...
      /// the user of the JointControllerNewImpl.
      ...
      /// set by the user of the JointControllerNewImpl.
      ...
      private: JointControllerNewImplPrivate *dataPtr;
    };
    /// \}
  }
}
