#ifndef JACOJOINTS_JACOTRAJECTORYACTIONSERVERKINOVA_H
#define JACOJOINTS_JACOTRAJECTORYACTIONSERVERKINOVA_H
 ...
 */
class JacoTrajectoryActionServerKinova: public jaco_joints::JacoTrajectoryActionServer, public hardware_interface::RobotHW
{
private:
...
public:
    ...
    JacoTrajectoryActionServerKinova(
        ...
        double _maxSpeed123 = MAX_SPEED_123_DEG * DEG_TO_RAD, double _maxSpeed456 =  MAX_SPEED_456_DEG * DEG_TO_RAD,
        const std::string& jointStateTopic = "", const float jointStateFreq = 25,
        float _armAngleSafetyLimit = DEFAULT_ANGLE_SAFETY_LIMIT, float goalTolerance = DEFAULT_GOAL_TOLERANCE,
        ...
        bool _useOnlineVelocityControl = true, float _interGoalTolerance = 2 * DEFAULT_GOAL_TOLERANCE);
...
#endif  // JACOJOINTS_JACOTRAJECTORYACTIONSERVERKINOVA_H
